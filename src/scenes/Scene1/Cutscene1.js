...
export class Cutscene1 extends Phaser.Scene {
    ...
    create() {
        let Dialogs = [
            ...
            "Atunci feciorul cel mijlociu zice: \n\n— Tată, să mă duc eu, dacă vrei. ",
            ...
            "— De unde dai, milostivul Dumnezeu să-ți dea și mult să te înzilească, luminate crăișor, că mare norocire te așteaptă. Puțin mai este, și ai să ajungi împărat, care n-a mai stat altul pe fața pământului așa de iubit, de slăvit și de puternic. Acum, luminate crăișor, ca să vezi cât poate să-ți ajute milostenia, stai liniștit, uită-te drept în ochii mei și ascultă cu luare-aminte ce ți-oi spune:",
        ...
        let Backgrounds = [
            ...
            "B9", "B10", "B11", "B12", "B13", "B12", "B14", "B12",
            "B8", "B15", "B12", "B16", "B12", "B12", "B12", "B17", "B18", "B19",
            "B20", "B19", "B19", "B19"
        ]
