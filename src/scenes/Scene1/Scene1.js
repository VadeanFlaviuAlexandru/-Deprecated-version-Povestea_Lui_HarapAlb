...
export class Scene1 extends Phaser.Scene {
    ...
    create() {
        ...
        const tileset5Castle = mapCastle.addTilesetImage("StoneTiles", "tiles5Castle")
        const tileset7Castle = mapCastle.addTilesetImage("StructureTiles", "tiles7Castle")
        const tileset3Castle = mapCastle.addTilesetImage("FenceTiles", "tiles3Castle")
        const tileset6Castle = mapCastle.addTilesetImage("PropsTiles", "tiles6Castle")
        const tileset2Castle = mapCastle.addTilesetImage("PlantTiles", "tiles2Castle")
        const tileset8Castle = mapCastle.addTilesetImage("WallsTiles2", "tiles8Castle")
        const portallayerCastle = mapCastle.createLayer("PortalLayer", tileset6Castle)
        const layer1Castle = mapCastle.createLayer("GrassLayer", tilesetCastle)
        const layer2Castle = mapCastle.createLayer("OuterWallsLayer", tileset5Castle)
        ...
        const layer7Castle = mapCastle.createLayer("UpperTilesLayer", tileset5Castle)
        const layer8Castle = mapCastle.createLayer("UpperWallsLayer", tileset8Castle)
        const layer6Castle = mapCastle.createLayer("PlantLayer", tileset2Castle)
        const layer9Castle = mapCastle.createLayer("PlantTreeLayer", tileset2Castle)
        ...
        this.physics.add.collider(this.player, portallayerCastle, this.HitLayer.bind(this))
        this.physics.add.collider(this.player, layer3Castle, this.HitLayer.bind(this))
        this.physics.add.collider(this.player, layer4Castle, this.HitLayer.bind(this))
        this.physics.add.collider(this.player, layer5Castle, this.HitLayer.bind(this))
        this.physics.add.collider(this.player, layer6Castle, this.HitLayer.bind(this))
        this.physics.add.collider(this.player, layer9Castle, this.HitLayer.bind(this))
        // camera
