...
export class Main extends Phaser.Scene {
  ...
  create() {
    ...
    Align.ScaleToGameW(this.game, this.Background, 1.25);
    ...
    newgameButton.setTint(0x0fff00);
    //
    ...
    controlsButton.setTint(0x0fff00);
    //
    ...
    newgameButton.on("pointerover", () => {
      newgameButton.setTint(0x00ffff);
    });
